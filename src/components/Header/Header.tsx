...
const Header = ({ title, toggleTheme }: HeaderProps) => {
  return (
    <div
      id="main-header"
      className="w-full fixed z-50 bg-white dark:bg-common-blue h-20 shadow-md flex justify-center text-dark-blue dark:text-white transition-all ease-linear duration-500"
    >
